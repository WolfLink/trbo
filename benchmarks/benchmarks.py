...
PATHS = {"benchmarks" : os.path.dirname(os.path.abspath(__file__))}
PATHS["synthetiq"] = os.path.join(PATHS["benchmarks"], "synthetiq")
PATHS["inputs"] = os.path.join(PATHS["benchmarks"], "inputs")
PATHS["outputs"] = os.path.join(PATHS["benchmarks"], "inputs")
PATHS["summary"] = os.path.join(PATHS["benchmarks"], "output_summary.tsv")
PATHS["database"] = os.path.join(PATHS["benchmarks"], "benchmark_database.json")
...
def log(text):
    with open(os.path.join(PATHS["benchmarks"], "benchmarks.log"), "a") as f:
