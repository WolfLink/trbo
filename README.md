...
- gridsynth (https://www.mathstat.dal.ca/~selinger/newsynth/)
...
- `GridsynthPass`: This is a pass that uses [`gridsynth`](https://www.mathstat.dal.ca/~selinger/newsynth/) to convert any remaining Rz gates to Clifford+T.  We provide a simple script to build gridsynth from source within a Docker container in `ntro/ntro/newsynth`.
